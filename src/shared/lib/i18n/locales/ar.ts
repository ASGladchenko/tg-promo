export const arTranslation = {
  attempts: {
    ...
    inviteFriend: {
      ...
      shareText: "🔐 ساعدني في فتح الخزنة. افتح هذه الدعوة والعب، وسيحصل كلانا على محاولات إضافية كمكافأة."
    },
    channelSubscription: {
      bonusGranted: "تم تأكيد الاشتراك في القناة. تمت إضافة المكافأة اليومية.",
    ...
    rewards: {
      ...
      inviteFriend: {
        description: "ادعُ صديقًا لفتح الخزنة. سيحصل كل منكما على المكافأة عندما ينضم عبر رابطك.",
        title: "دعوة صديق"
      },
      subscribeChannel: {
    ...
    rewardsError: "تعذر تحميل مكافآت المحاولات.",
    rewardsLoading: "جارٍ تحميل مكافآت المحاولات...",
  ...
  lottery: {
    ...
    chooseDigit: "اختر الرقم {{digit}} للموضع {{position}}",
    chooseDigitPosition: "اختر الرقم {{position}}",
