...
12. Не создавай пустые папки и не оставляй устаревшие файлы после переноса.
13. Не выполняй несвязанный рефакторинг.
14. Не откатывай незакоммиченные изменения пользователя.
15. Не переписывай вручную одинаковые поля между DTO, domain, form и payload types. Если тип почти
